...
from ...shared.exceptions.game_exceptions import GameNotFoundException, PersistenceException
    ...
    async def list_games(self, player_id: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for game_id, metadata in self._metadata.items():
                ...
                if player_id and player_id not in [metadata["white_player"], metadata["black_player"]]:
                    continue
