...
class BoardEvent(DomainEvent):
    ...
    @classmethod
    def move_made(cls, move: chess.Move, fen: str, current_player: Player) -> 'BoardEvent':
        return cls(
    ...
    @classmethod
    def move_undone(cls, undone_move: chess.Move, fen: str, current_player: Player) -> 'BoardEvent':
        return cls(
...
class GameEvent(DomainEvent):
    ...
    @classmethod
    def game_ended(cls, game_id: str, result: GameResult, winner: Optional[Player] = None) -> 'GameEvent':
        return cls(
    ...
    @classmethod
    def square_selected(cls, game_id: str, square: int, valid_moves: list) -> 'GameEvent':
        return cls(
...
class EventFactory:
    ...
    @staticmethod
    def create_move_event(move: chess.Move, fen: str, current_player: Player) -> BoardEvent:
        """Create a move made event."""
        return BoardEvent.move_made(move, fen, current_player)
    
    @staticmethod
    def create_selection_event(game_id: str, square: int, valid_moves: list) -> GameEvent:
        """Create a square selection event."""
        return GameEvent.square_selected(game_id, square, valid_moves)
    
    @staticmethod
    def create_game_end_event(game_id: str, result: GameResult, winner: Optional[Player] = None) -> GameEvent:
