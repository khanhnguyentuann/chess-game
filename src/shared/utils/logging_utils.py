...
class GameLogger:
    ...
    def log_game_start(self, game_id: str, white_player: str, black_player: str) -> None:
        """Log game start."""
        self.logger.info(
    ...
    def log_error(self, game_id: str, error_type: str, message: str, details: Optional[str] = None) -> None:
        """Log game error."""
        error_msg = f"Game error - ID: {game_id}, Type: {error_type}, Message: {message}"
        if details:
