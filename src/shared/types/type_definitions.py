...
from typing import Protocol, Optional, List, Dict, Any, Callable, Tuple, NamedTuple, TYPE_CHECKING
...
from .enums import GameState, Player, GameResult, InputAction
...
class GameEngine(Protocol):
    ...
    def get_best_move(self, board: Any, time_limit: float = 1.0) -> Optional[chess.Move]:
...
class ViewAdapter(Protocol):
    ...
    def show_screen(self, screen_type: str, data: Optional[Dict[str, Any]] = None) -> None:
