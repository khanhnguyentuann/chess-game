...
class PieceRenderer:
    ...
    def _draw_pawn(self, surface: pygame.Surface, color: str):
        ...
        shadow_color = self.WHITE_PIECE_SHADOW if color == 'w' else self.BLACK_PIECE_SHADOW
        highlight_color = self.WHITE_PIECE_HIGHLIGHT if color == 'w' else self.BLACK_PIECE_HIGHLIGHT
        ...
        # Shadow
        pygame.draw.rect(surface, shadow_color, (base_x + 2, base_y + 2, base_width, base_height))
        # Main base
        pygame.draw.rect(surface, fill_color, (base_x, base_y, base_width, base_height))
        # Highlight
        pygame.draw.rect(surface, highlight_color, (base_x, base_y, base_width, base_height // 3))
        pygame.draw.rect(surface, outline_color, (base_x, base_y, base_width, base_height), 2)
        ...
        # Shadow
        pygame.draw.rect(surface, shadow_color, (body_x + 2, body_y + 2, body_width, body_height))
        # Main body
        pygame.draw.rect(surface, fill_color, (body_x, body_y, body_width, body_height))
        # Highlight
        pygame.draw.rect(surface, highlight_color, (body_x, body_y, body_width, body_height // 3))
        pygame.draw.rect(surface, outline_color, (body_x, body_y, body_width, body_height), 2)
        ...
        # Highlight
        pygame.draw.circle(surface, highlight_color, (head_x - head_radius//3, head_y - head_radius//3), head_radius//2)
        ...
        # Crown base
        pygame.draw.rect(surface, self.GOLD, (crown_x, crown_y, crown_width, crown_height))
        pygame.draw.rect(surface, self.GOLD_SHADOW, (crown_x, crown_y, crown_width, crown_height), 1)
        ...
        for jewel_x, jewel_y in jewel_positions:
            ...
            pygame.draw.circle(surface, outline_color, (jewel_x, jewel_y), jewel_radius, 1)
    ...
    def _draw_rook(self, surface: pygame.Surface, color: str):
        ...
        for i in range(3):
            ...
            # Shadow
            pygame.draw.rect(surface, shadow_color, (battlement_x + 1, body_y - battlement_height + 1, battlement_width, battlement_height))
            # Main battlement
            pygame.draw.rect(surface, fill_color, (battlement_x, body_y - battlement_height, battlement_width, battlement_height))
            # Highlight
            pygame.draw.rect(surface, highlight_color, (battlement_x, body_y - battlement_height, battlement_width, battlement_height // 3))
            pygame.draw.rect(surface, outline_color, (battlement_x, body_y - battlement_height, battlement_width, battlement_height), 1)
        ...
        # Cross shadow
        pygame.draw.line(surface, shadow_color, (cross_x - cross_size + 1, cross_y + 1), (cross_x + cross_size + 1, cross_y + 1), cross_thickness)
        pygame.draw.line(surface, shadow_color, (cross_x + 1, cross_y - cross_size + 1), (cross_x + 1, cross_y + cross_size + 1), cross_thickness)
        
        # Main cross
        pygame.draw.line(surface, self.GOLD, (cross_x - cross_size, cross_y), (cross_x + cross_size, cross_y), cross_thickness)
        pygame.draw.line(surface, self.GOLD, (cross_x, cross_y - cross_size), (cross_x, cross_y + cross_size), cross_thickness)
        
        # Cross outline
        pygame.draw.line(surface, self.GOLD_SHADOW, (cross_x - cross_size, cross_y), (cross_x + cross_size, cross_y), 1)
        pygame.draw.line(surface, self.GOLD_SHADOW, (cross_x, cross_y - cross_size), (cross_x, cross_y + cross_size), 1)
    ...
    def _draw_knight(self, surface: pygame.Surface, color: str):
        ...
        body_points = [
            ...
            (base_x + base_width//2 - int(size * 0.16), base_y - int(size * 0.22)),  # Left curve
            (base_x + int(size * 0.12), base_y - int(size * 0.12)),  # Left bottom
            (base_x + base_width - int(size * 0.12), base_y - int(size * 0.12)),  # Right bottom
            (base_x + base_width//2 + int(size * 0.16), base_y - int(size * 0.22)),  # Right curve
        ]
        ...
        # Eye highlight
        pygame.draw.circle(surface, highlight_color, (eye_x - eye_radius//3, eye_y - eye_radius//3), eye_radius//3)
    ...
    def _draw_bishop(self, surface: pygame.Surface, color: str):
        ...
        # Slit shadow
        pygame.draw.rect(surface, shadow_color, (slit_x + 1, slit_y + 1, slit_width, slit_height))
        # Main slit
        pygame.draw.rect(surface, detail_color, (slit_x, slit_y, slit_width, slit_height))
        pygame.draw.rect(surface, outline_color, (slit_x, slit_y, slit_width, slit_height), 1)
    ...
    def _draw_queen(self, surface: pygame.Surface, color: str):
        ...
        # Crown shadow
        pygame.draw.rect(surface, shadow_color, (crown_x + 2, crown_y + 2, crown_width, crown_height))
        # Crown base
        pygame.draw.rect(surface, fill_color, (crown_x, crown_y, crown_width, crown_height))
        # Crown highlight
        pygame.draw.rect(surface, highlight_color, (crown_x, crown_y, crown_width, crown_height // 3))
        pygame.draw.rect(surface, outline_color, (crown_x, crown_y, crown_width, crown_height), 2)
        ...
        for jewel_x, jewel_y in jewel_positions:
            # Jewel shadow
            pygame.draw.circle(surface, shadow_color, (jewel_x + 1, jewel_y + 1), jewel_radius)
            # Main jewel
            pygame.draw.circle(surface, self.GOLD, (jewel_x, jewel_y), jewel_radius)
            # Jewel highlight
            pygame.draw.circle(surface, highlight_color, (jewel_x - jewel_radius//3, jewel_y - jewel_radius//3), jewel_radius//3)
            pygame.draw.circle(surface, self.GOLD_SHADOW, (jewel_x, jewel_y), jewel_radius, 1)
